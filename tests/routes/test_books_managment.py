"""
Test suite for books management functions in lottery_app.routes.books.
...
@pytest.fixture
def books_url():
    """Return the books management URL."""
    return "/books_managment"


@pytest.fixture
def activate_url():
    """Return the activate book URL."""
    return "/activate_book"


@pytest.fixture
def deactivate_url():
    """Return the deactivate book URL."""
    return "/deactivate_book"


@pytest.fixture
def delete_url():
    """Return the delete book URL."""
    return "/delete_book"


def test_books_management_get(auth, client):
    """GET /books_managment returns 200 when authenticated."""
    auth.login()
...
def test_books_management_get_with_flash(auth, client):
    """GET with flash query params renders the page without error."""
    auth.login()
    response = client.get(
...
def test_books_management_post_add_book_success(add_book_mock, auth, client):
    """POST with a valid book code calls add_book_procedure once."""
    auth.login()
...
def test_books_management_books_with_ticket_names(
    ...
    """Books table populates correctly with resolved ticket names."""
    auth.login()
...
def test_books_management_activated_books(
    ...
    """Activated books are fetched and passed to the template."""
    auth.login()
...
def test_delete_book_missing_id(auth, client):
    """POST /delete_book without bookID returns 400."""
    auth.login()
    response = client.post(
        "/delete_book",
        json={},
...
def test_delete_book_deactivate_error(deactivate_mock, auth, client):
    """POST /delete_book returns 500 when deactivation raises."""
    auth.login()
...
def test_delete_book_success(
    ...
    """POST /delete_book with a valid bookID returns a success response."""
    auth.login()
...
def test_deactivate_book_invalid(auth, client):
    """POST /deactivate_book without bookID returns 400."""
    auth.login()
...
def test_deactivate_book_db_error(deactivate_mock, auth, client):
    """POST /deactivate_book returns 500 on a database error."""
    auth.login()
...
def test_deactivate_book_success(deactivate_mock, auth, client):
    """POST /deactivate_book with a valid bookID returns 200."""
    auth.login()
    deactivate_mock.return_value = None
...
def test_activate_book_invalid(activate_mock, auth, client):
    """POST /activate_book with an invalid code redirects."""
    auth.login()
...
def test_activate_book_success(activate_mock, auth, client):
    """POST /activate_book with a valid code redirects."""
    auth.login()
