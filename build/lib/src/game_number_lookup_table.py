...
def remove_ticketname_gm_track(file_name):
    ...
    Returns:
        None
    """
    ticketname_gm_track_file_path = os.path.join(db_dir, file_name)
...
def track_gms_in_lookup_table(db_path,
    ...
    with open(gm_track_file_path, "w", encoding="utf-8") as f:
        temp_string = ""
...
def compare_game_numbers(db_path, file_name):
    """
    ...
    track_df = load_from_gm_track_file(file_name)
